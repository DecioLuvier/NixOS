        ...
        home-manager.sharedModules = [
          {
            ...
            wayland.windowManager.hyprland = {
              enable = true;
              # HM 26.05 mudou o default para "lua"; mantemos hyprlang explicitamente
              # (Hyprland 0.55.4 do 26.05, config abaixo e todo hyprlang).
              configType = "hyprlang";
              settings = {
                "$mainMod" = "SUPER";
                ...
                # pseudotile deixou de ser opcao de config; agora e so dispatcher (bind abaixo).
