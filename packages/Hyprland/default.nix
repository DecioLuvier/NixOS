        ...
        home-manager.sharedModules = [
          {
            ...
            wayland.windowManager.hyprland = {
              ...
              settings = {
                ...
                misc    = { disable_hyprland_logo = true; disable_splash_rendering = true; "col.splash" = "rgb(41b883)"; background_color = "rgb(163249)"; enable_swallow = true; focus_on_activate = true; vrr = 0; };
