...
GtkWidget* create(GtkApplication* app) {
    ...
    gtk_widget_add_css_class(window, "bar-top");
    gtk_widget_set_size_request(window, -1, kHeight);
    ...
    gtk_layer_set_namespace(win, "bar-top");
    ...
    gtk_layer_set_margin(win, GTK_LAYER_SHELL_EDGE_LEFT, kMargin);
    gtk_layer_set_margin(win, GTK_LAYER_SHELL_EDGE_RIGHT, kMargin);
    gtk_layer_set_margin(win, GTK_LAYER_SHELL_EDGE_TOP, kMargin);
    gtk_layer_set_exclusive_zone(win, kHeight + kMargin);
